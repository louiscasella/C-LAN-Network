...
Projet réalisé avec [Leo-Galien](https://github.com/Leo-Galien) . Ce simulateur modélise un réseau local Ethernet avec commutation de trames et protocole STP, à l'aide d'un ordonnanceur à événements discrets.
